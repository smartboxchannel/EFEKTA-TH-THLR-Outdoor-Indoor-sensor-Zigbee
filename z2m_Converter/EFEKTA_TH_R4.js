...
const definition = {
        ...
        model: 'EFEKTA_TH',
        vendor: 'EfektaLab',
        description: 'EFEKTA_TH - temperature and humidity sensors with AAA batteries. Thermostat and hygrostat.',
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
			...
			const overrides1 = {min: 0, max: 43200, change: 0};
			const overrides2 = {min: 0, max: 3600, change: 0};
			const overrides3 = {min: 0, max: 3600, change: 0};
