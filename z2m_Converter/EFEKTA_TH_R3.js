...
const definition = {
        ...
        model: 'EFEKTA_TH',
        vendor: 'EfektaLab',
        description: 'EFEKTA_TH - temperature and humidity sensors with increased battery life. Thermostat and hygrostat.',
        ...
        configure: async (device, coordinatorEndpoint, logger) => {
			...
			const overrides2 = {min: 120, max: 3600, change: 25};
