...
const tzLocal = {
	...
	termostat_config: {
        ...
        convertGet: async (entity, key, meta) => {
            const payloads = {
                high_temp: ['msTemperatureMeasurement', 0x0202],
                low_temp: ['msTemperatureMeasurement', 0x0203],
				enable_temp: ['msTemperatureMeasurement', 0x0206],
            };
	...
	hydrostat_config: {
        ...
        convertGet: async (entity, key, meta) => {
            const payloads = {
                high_hum: ['msRelativeHumidity', 0x0204],
                low_hum: ['msRelativeHumidity', 0x0205],
				enable_hum: ['msRelativeHumidity', 0x0207],
            };
            await entity.read(payloads[key][0], [payloads[key][1]]);
        },
    },
...
const definition = {
        ...
        fromZigbee: [fz.temperature, fz.humidity, fz.pressure, fz.battery, fzLocal.termostat_config, fzLocal.hydrostat_config, fzLocal.node_config],
